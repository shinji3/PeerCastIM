...
void Servent::handshakeCMD(char *cmd)
{
    ...
    try
    {
        if (cmpCGIarg(cmd, "cmd=", "redirect"))
        {
            ...
            {
                sys->logBuf->clear();
                snprintf(jumpStr, _countof(jumpStr), "/%s/viewlog.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "save"))
            {
                ...
                snprintf(jumpStr, _countof(jumpStr), "/%s/settings.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            }
            else if (cmpCGIarg(cmd, "cmd=", "reg"))
            {
                ...
                snprintf(jumpStr, _countof(jumpStr), "http://www.peercast.org/register/?id=%s", idstr);
                jumpArg = jumpStr;
            }
            else if (cmpCGIarg(cmd, "cmd=", "edit_bcid"))
            {
                ...
                peercastInst->saveSettings();
                snprintf(jumpStr, _countof(jumpStr), "/%s/bcid.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "apply"))
            {
                ...
                if (servMgr->serverHost.port != newPort)
                {
                    ...
                    char ipstr[64];
                    lh.toStr(ipstr);
                    snprintf(jumpStr, _countof(jumpStr), "http://%s/%s/settings.html", ipstr, servMgr->htmlPath);
                    ...
                    //snprintf(jumpStr, _countof(jumpStr),"/%s/settings.html",ipstr,servMgr->htmlPath);					
                    jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "fetch"))
            {
                ...
                snprintf(jumpStr, _countof(jumpStr), "/%s/relays.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "stopserv"))
            {
                ...
                snprintf(jumpStr, _countof(jumpStr), "/%s/connections.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "clear"))
            {
                ...
                snprintf(jumpStr, _countof(jumpStr), "/%s/index.html", servMgr->htmlPath);
                jumpArg = jumpStr;
            ...
            else if (cmpCGIarg(cmd, "cmd=", "upgrade"))
            {
                ...
                {
                    snprintf(jumpStr, _countof(jumpStr), "/admin?cmd=redirect&url=%s", servMgr->downloadURL);
                    jumpArg = jumpStr;
                }
                        ...
                        /*						String chname;
                                                ...
                                                for(int i=0; i<ChanMgr::MAX_CHANNELS; i++)
                                                {
                                                    ...
                                                    if ((c->isActive()) && (c->status == Channel::S_BROADCASTING) && (strcmp(c->info.name.cstr(),chname.cstr())==0))
                                                    {
                                                        ...
                                                        snprintf(jumpStr, _countof(jumpStr),"/%s/relayinfo.html?id=%s",servMgr->htmlPath,idstr);
                                                        jumpArg = jumpStr;
                                                        break;
                                                    }
                                                }*/
